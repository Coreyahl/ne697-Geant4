...
void B3DetectorConstruction::DefineMaterials()
{
  ...
  //add NaI material to change detector material later
  //G4Material* NaI = man->FindOrBuildMaterial("G4_SODIUM_IODIDE");
  //since NaI is a build in material, like G4_AIR, i dont think I need this ^^
}
...
{  
  ...
  //change crystal material from LSO to NaI
